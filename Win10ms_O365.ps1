...
New-ItemProperty -Path 'HKLM:\Software\FSLogix\Profiles' -Name 'VHDLocations' -Value '\\vmanfsmb-d5da.int.nihp.nhs.uk\volenguksouth001' -PropertyType MultiString -Force | Out-Null
